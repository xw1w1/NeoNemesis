...
public:
    ...
    NEMESIS_API NTSTATUS CreateVEH( class Process& proc, ModuleData& mod, bool partial );
    ...
    NEMESIS_API NTSTATUS RemoveVEH( class Process& proc, bool partial, eModType mt );

    /// <summary>
    /// Reset data
    /// </summary>
    NEMESIS_API void reset() { _pModTable.Free(); }
