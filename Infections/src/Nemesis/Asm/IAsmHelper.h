...
namespace nemesis
{
    ...
    {
    public:
        NEMESIS_API IAsmHelper( uint32_t arch = asmjit::kArchHost ) 
        ...
        NEMESIS_API inline asmjit::X86Assembler* assembler() { return &_assembler; }
        NEMESIS_API inline asmjit::X86Assembler* operator ->() { return &_assembler; }
