...
public:
    NEMESIS_API RemoteMemory( class Process* process );
    NEMESIS_API ~RemoteMemory();
    ...
    NEMESIS_API NTSTATUS Map( bool mapSections );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS Map( ptr_t base, uint32_t size );

    /// <summary>
    /// Unmap process address space from current process
    /// </summary>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS Unmap();
    ...
    /// <param name="size">Region size</param>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS Unmap( ptr_t base, uint32_t size );
    ...
    NEMESIS_API ptr_t TranslateAddress( ptr_t address, bool resolveFault = true );
    ...
    NEMESIS_API NTSTATUS SetupHook( OperationType hkType );
    ...
    /// <returns>true on success</returns>
    NEMESIS_API bool RestoreHook( OperationType hkType );
