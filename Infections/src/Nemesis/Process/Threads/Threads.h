...
{
public:
    NEMESIS_API ProcessThreads( class ProcessCore& core );
    NEMESIS_API ~ProcessThreads();
    ...
    NEMESIS_API call_result_t<ThreadPtr> CreateNew(
        ptr_t threadProc,
        ptr_t arg,
    ...
    NEMESIS_API std::vector<ThreadPtr> getAll() const;

    /// <summary>
    /// Get main process thread
    /// </summary>
    /// <returns>Pointer to thread object, nullptr if failed</returns>
    NEMESIS_API ThreadPtr getMain() const;

    /// <summary>
    /// Get least executed thread
    /// </summary>
    /// <returns>Pointer to thread object, nullptr if failed</returns>
    NEMESIS_API ThreadPtr getLeastExecuted() const;

    /// <summary>
    /// Get most executed thread
    /// </summary>
    /// <returns>Pointer to thread object, nullptr if failed</returns>
    NEMESIS_API ThreadPtr getMostExecuted() const;

    /// <summary>
    /// Get random thread
    /// </summary>
    /// <returns>Pointer to thread object, nullptr if failed</returns>
    NEMESIS_API ThreadPtr getRandom() const;
    ...
    /// <returns>Pointer to thread object, nullptr if failed</returns>
    NEMESIS_API ThreadPtr get( DWORD id ) const;
