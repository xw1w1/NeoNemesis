...
{
public:
    NEMESIS_API Native( HANDLE hProcess, bool x86OS = false );
    NEMESIS_API ~Native();

    NEMESIS_API inline const Wow64Barrier& GetWow64Barrier() const { return _wowBarrier; }
    ...
    NEMESIS_API std::vector<ModuleDataPtr> EnumModules( eModSeachType search = LdrList, eModType mtype = mt_default );

    /// <summary>
    /// Get lowest possible valid address value
    /// </summary>
    /// <returns>Address value</returns>
    NEMESIS_API inline ptr_t minAddr() const { return 0x10000; }

    /// <summary>
    /// Get highest possible valid address value
    /// </summary>
    /// <returns>Address value</returns>
    NEMESIS_API inline ptr_t maxAddr() const { return 0x7FFFFFFEFFFF; }
    
    /// <summary>
    /// Get highest possible valid address value
    /// </summary>
    /// <returns>Address value</returns>
    NEMESIS_API inline ptr_t maxAddr32() const { return 0x7FFFFFFF; }
                                                                        
    /// <summary>
    /// Get page size
    /// </summary>
    /// <returns>Address value</returns>
    NEMESIS_API inline uint32_t pageSize() const { return _pageSize; }
private:
