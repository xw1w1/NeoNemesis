...
public:
    ...
    NEMESIS_API NTSTATUS Load( SymbolData& result );
    ...
    /// <param name="result">Found symbols</param>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS LoadFromSymbols( const pe::PEImage& ntdll32, const pe::PEImage& ntdll64, SymbolData& result );
    ...
    /// <param name="result">Found symbols</param>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS LoadFromPatterns( const pe::PEImage& ntdll32, const pe::PEImage& ntdll64, SymbolData& result );

    /// <summary>
    /// Load ntdll images from the disk
    /// </summary>
    /// <returns>Loaded x86 and x64 ntdll</returns>
    NEMESIS_API std::pair<pe::PEImage, pe::PEImage> LoadImages();
