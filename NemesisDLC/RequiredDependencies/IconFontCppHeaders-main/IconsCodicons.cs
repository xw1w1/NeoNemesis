...
namespace IconFonts
{
    public class Codicons
    {
        ...
        public const int IconMax16 = 0xecc3;
        public const int IconMax = 0xecc3;
        ...
        public const string ShareWindow = "\uec88";
        public const string CircleSlashCompact = "\uec89";
        public const string CopilotCompact = "\uec8a";
        public const string FolderOpenedCompact = "\uec8b";
        public const string FolderCompact = "\uec8c";
        public const string GearCompact = "\uec8d";
        public const string GitBranchCompact = "\uec8e";
        public const string LibraryCompact = "\uec8f";
        public const string RecordKeysCompact = "\uec90";
        public const string RemoteCompact = "\uec91";
        public const string RepoForkedCompact = "\uec92";
        public const string RepoCompact = "\uec93";
        public const string ShieldCompact = "\uec94";
        public const string SparkleCompact = "\uec95";
        public const string SymbolColorCompact = "\uec96";
        public const string WindowCompact = "\uec97";
        public const string ErrorCompact = "\uec98";
        public const string WarningCompact = "\uec99";
        public const string PassCompact = "\uec9a";
        public const string Important = "\uec9b";
        public const string ImportantCompact = "\uec9c";
        public const string RocketCompact = "\uec9d";
        public const string Unpin = "\uec9e";
        public const string AddCompact = "\uec9f";
        public const string AttachCompact = "\ueca0";
        public const string BeakerCompact = "\ueca1";
        public const string CheckCompact = "\ueca2";
        public const string ChecklistCompact = "\ueca3";
        public const string ChevronDownCompact = "\ueca4";
        public const string ChevronLeftCompact = "\ueca5";
        public const string ChevronRightCompact = "\ueca6";
        public const string ChevronUpCompact = "\ueca7";
        public const string CircleFilledCompact = "\ueca8";
        public const string CircleSmallFilledCompact = "\ueca9";
        public const string CloseCompact = "\uecaa";
        public const string CollapseAllCompact = "\uecab";
        public const string CommentCompact = "\uecac";
        public const string CommentUnresolvedCompact = "\uecad";
        public const string DebugConnectedCompact = "\uecae";
        public const string DebugDisconnectCompact = "\uecaf";
        public const string EditCompact = "\uecb0";
        public const string FileMediaCompact = "\uecb1";
        public const string GitFetch = "\uecb2";
        public const string LightbulbCompact = "\uecb3";
        public const string LoadingCompact = "\uecb4";
        public const string PassFilledCompact = "\uecb5";
        public const string ProjectCompact = "\uecb6";
        public const string RefreshCompact = "\uecb7";
        public const string SearchCompact = "\uecb8";
        public const string SessionInProgressCompact = "\uecb9";
        public const string SyncCompact = "\uecba";
        public const string TerminalCompact = "\uecbb";
        public const string VmPending = "\uecbc";
        public const string WorktreeCompact = "\uecbd";
        public const string DeveloperTools = "\uecbe";
        public const string CloudCompact = "\uecbf";
        public const string AgentCompact = "\uecc0";
        public const string AskCompact = "\uecc1";
        public const string SettingsCompact = "\uecc2";
        public const string VmCompact = "\uecc3";
    }
}
