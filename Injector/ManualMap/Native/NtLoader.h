...
{
public:
    NEMESIS_API NtLdr( class Process& proc );
    ...
    NEMESIS_API bool Init( eModType initFor = mt_default );
    ...
    /// <returns>true on success</returns>
    NEMESIS_API bool CreateNTReference( NtLdrEntry& mod );
    ...
    NEMESIS_API NTSTATUS AddStaticTLSEntry( NtLdrEntry& mod, ptr_t tlsPtr );
    ...
    /// <param name="mod">Module data</param>
    /// <returns>true on success</returns>
    NEMESIS_API bool InsertInvertedFunctionTable( NtLdrEntry& mod );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS UnloadTLS( const NtLdrEntry& mod, bool noThread = false );
    ...
    /// <returns>true on success</returns>
    NEMESIS_API bool Unlink( const ModuleData& mod, bool noThread = false );
private:
