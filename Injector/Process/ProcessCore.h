...
public:
    ...
    NEMESIS_API inline bool isWow64() const { return _native->GetWow64Barrier().targetWow64; }

    /// <summary>
    /// Get process handle
    /// </summary>
    /// <returns>Process handle</returns>
    NEMESIS_API inline HANDLE handle() const { return _hProcess; }

    /// <summary>
    /// Get process ID
    /// </summary>
    /// <returns>Process ID</returns>
    NEMESIS_API inline DWORD pid() const { return _pid; }

    /// <summary>
    /// Get process data execution prevention state
    /// </summary>
    /// <returns>true if DEP is enabled for process</returns>
    NEMESIS_API inline bool DEP() const { return _dep; };
  
    /// <summary>
    /// Get system routines
    /// </summary>
    /// <returns></returns>
    NEMESIS_API inline Native* native() { return _native.get(); }
    ...
    NEMESIS_API inline ptr_t peb32( _PEB32* ppeb = nullptr ) { return _native->getPEB( ppeb ); }
    ...
    /// <returns>PEB pointer</returns>
    NEMESIS_API inline ptr_t peb64( _PEB64* ppeb = nullptr ) { return _native->getPEB( ppeb ); }
    ...
    NEMESIS_API inline ptr_t peb( _PEB_T<T>* ppeb = nullptr ) { return _native->getPEB( ppeb ); }

    /// <summary>
    /// Check if process is a protected process
    /// </summary>
    /// <returns>true if protected</returns>
    NEMESIS_API bool isProtected();
