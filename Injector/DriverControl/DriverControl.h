...
{
public:
    NEMESIS_API DriverControl();
    NEMESIS_API ~DriverControl();

    NEMESIS_API static DriverControl& Instance();
    ...
    NEMESIS_API NTSTATUS EnsureLoaded( const std::wstring& path = L"" );
    ...
    /// <param name="path">Path to the driver file</param>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS Reload( std::wstring path = L"" );

    /// <summary>
    /// Unload driver
    /// </summary>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS Unload();
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS DisableDEP( DWORD pid );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS ProtectProcess( 
        DWORD pid, 
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS PromoteHandle( DWORD pid, HANDLE handle, DWORD access );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS AllocateMem( DWORD pid, ptr_t& base, ptr_t& size, DWORD type, DWORD protection, bool physical = false );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS FreeMem( DWORD pid, ptr_t base, ptr_t size, DWORD type );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS ReadMem( DWORD pid, ptr_t base, ptr_t size, PVOID buffer );
    ...
    /// <param name="buffer">Buffer address</param>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS WriteMem( DWORD pid, ptr_t base, ptr_t size, PVOID buffer );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS ProtectMem( DWORD pid, ptr_t base, ptr_t size, DWORD protection );
    ...
    /// <returns>Status code </returns>
    NEMESIS_API NTSTATUS MapMemory( DWORD pid, const std::wstring& pipeName, bool mapSections, MapMemoryResult& result );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS MapMemoryRegion( DWORD pid, ptr_t base, uint32_t size, MapMemoryRegionResult& result );
    ...
    /// <param name="pid">Target PID</param>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS UnmapMemory( DWORD pid );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS UnmapMemoryRegion( DWORD pid, ptr_t base, uint32_t size );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS InjectDll(
        DWORD pid, 
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS MMapDriver( const std::wstring& path );
    ...
    /// <param name="size">Region size</param>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS ConcealVAD( DWORD pid, ptr_t base, uint32_t size );
    ...
    /// <param name="pid">Target process ID</param>
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS UnlinkHandleTable( DWORD pid );
    ...
    /// <returns>Status code</returns>
    NEMESIS_API NTSTATUS EnumMemoryRegions( DWORD pid, std::vector<MEMORY_BASIC_INFORMATION64>& regions );

    /// <summary>
    /// Check if driver is loaded
    /// </summary>
    /// <returns></returns>
    NEMESIS_API inline bool loaded() const { return _hDriver.valid(); }
    NEMESIS_API inline NTSTATUS status() const { return _loadStatus; }
